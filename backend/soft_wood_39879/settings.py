"""
Django settings for soft_wood_39879 project.
...
ROOT_URLCONF = 'soft_wood_39879.urls'
...
WSGI_APPLICATION = 'soft_wood_39879.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "soft_wood_39879 API",
    "DESCRIPTION": "API documentation for soft_wood_39879 App",
    "VERSION": "v1",
}
